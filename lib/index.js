...
function Strategy(options, verify) {
  ...
  var defaultOptions = {
    authorizationURL: (options.protocol || presetOptions.protocol) + '://' + options.domain + '/' + (options.authorizeUri || presetOptions.authorizeUri),
    tokenURL:         (options.protocol || presetOptions.protocol) + '://' + options.domain + '/' + (options.getTokenUri || presetOptions.getTokenUri),
    userInfoURL:      (options.protocol || presetOptions.protocol) + '://' + options.domain + '/' + (options.getUserUri || presetOptions.getUserUri),
    apiUrl:           (options.protocol || presetOptions.protocol) + '://' + options.domain + '/' + (options.apiUri || presetOptions.apiUri)
  }
